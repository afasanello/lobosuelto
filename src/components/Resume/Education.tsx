...
import EducationElem from "./EducationElem.tsx"

import data from "../../data/EducationData.ts"
import { fadeInFromLeft, fadeInFromRight } from "../../data/AnimationData.ts"


function Education(props: { showChildren: boolean }) {
 ...
 return (
   <article>
      <h1 className="border-b-2 text-right mb-4 text-2xl font-mono">Education</h1>
              ...
              return (
                ...
                >
                  <EducationElem 
                    ...
                    progress={data.data[id].progress}
                    truncated={data.data[id].truncated}
                    institution={data.data[id].institution}
                    location={data.data[id].location}
                    career={data.data[id].career}
                    from="left"
                  />
                </motion.div>
              )
